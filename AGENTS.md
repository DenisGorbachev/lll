...
* Must have methods:
  * `run`
    ...
    * Must call an LLM
      * Must use openai\_dive
      * Must use openai\_auth\_ext
...
edition = "2024"
rust-version = "1.85.0"
description = "LLM Linter"
license = "Apache-2.0 OR MIT"
homepage = "https://github.com/DenisGorbachev/lll"
repository = "https://github.com/DenisGorbachev/lll"
readme = "README.md"
keywords = []
categories = []
exclude = [
